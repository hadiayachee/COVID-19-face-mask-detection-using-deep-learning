...
#net = cv2.dnn.readNetFromDarknet("custom-yolov4-tiny-detector (3).cfg",r"custom-yolov4-tiny-detector_best (3).weights")

#classes = ['WITH MASK','WITHOUT MASK']

net = cv2.dnn.readNetFromDarknet("custom-yolov4-tiny-detector (4).cfg",r"custom-yolov4-tiny-detector_best (4).weights")
